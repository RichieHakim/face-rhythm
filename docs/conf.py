# -*- coding: utf-8 -*-
#
# face-rhythm documentation build configuration file, created by
# sphinx-quickstart.
#
...
sys.path.insert(0, os.path.abspath('../face_rhythm'))
...
latex_documents = [
    ('index',
     'face-rhythm.tex',
     u'face-rhythm Documentation',
     u"Akshay Jaggi", 'manual'),
]
