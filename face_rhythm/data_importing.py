...
from .helpers import VideoReaderWrapper
...
class Dataset_videos(FR_Module):
    ...
    def __init__(
        ...
        assert paths_videos is not None, "FR ERROR: paths_videos must be specified as a string or list of strings to paths of videos"
